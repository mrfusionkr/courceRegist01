![image](https://user-images.githubusercontent.com/70736001/123323630-bbdfec80-d570-11eb-8fd4-7638818d7f04.png)
...
```
• 교수는 수강 과목을 등록 할 수 있다.(제목, 내용, 정원, 기간)
• 수강 과목이 등록되면 수강 신청 항목이 등록되어 수강 신청이 가능하다.
• 학생은 수강 과목을 신청 할 수 있다.
• 수강 신청이 된 항목에 대해서 수강 담당자는 수강 확정 여부를 검토한다.
• 수강 담당 부서는 수강 확정 결과를 등록 한다.
• 검토가 완료되면 수강 과목에 대한 수강확정여부와 수강자 수가 등록(공지) 된다.
• 교수는 수강 과목을 취소/변경 할 수 있다.
• 수강과목이 취소 되면 수강 신청 및 수강 확정 정보도 취소 된다.
• 수강과목 등록/등록취소/수강확정 시 학생에게 SMS 를 발송한다.
• 학생은 개인별로 수강 신청한 과목의 현황을 조회 할 수 있다.
...
```
1. 트랜잭션
  - 수강이 확정되면 수강신청 황목에 수강확정여부와 수강자 수가 등록(공지) 된다. (Sync 호출)
2. 장애격리
  - 수강 확정 기능이 수행되지 않더라도 수강 등록, 수강 신청 기능은 365일 24시간 받을 수 있어야 한다. Async (event-driven), Eventual Consistency
  - 입찰참여 기능이 과중되면 사용자를 잠시 동안 받지 않고 입찰참여를 잠시후에 하도록 유도한다. Circuit breaker, fallback
3. 성능
  - 학생은 My Page 화면에서 수강 신청한 과목의 진행 상태를 확인 할 수 있어야 한다.CQRS - 조회전용 서비스
```
